 ...
 */
final class Version20240616161718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request CHANGE user_id user_id VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT FK_7CE748AA76ED395 FOREIGN KEY (user_id) REFERENCES users (ID)');
        $this->addSql('ALTER TABLE reset_password_request RENAME INDEX idx_user_id TO IDX_7CE748AA76ED395');
        ...
        $this->addSql('ALTER TABLE users DROP forgor, CHANGE ID ID VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE username username VARCHAR(255) NOT NULL, CHANGE photo photo LONGBLOB NOT NULL, CHANGE about about VARCHAR(255) NOT NULL, CHANGE role role INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request RENAME INDEX idx_7ce748aa76ed395 TO idx_user_id');
        ...
        $this->addSql('ALTER TABLE users ADD forgor VARCHAR(10) DEFAULT \'\'\'0\'\'\' NOT NULL, CHANGE ID ID INT AUTO_INCREMENT NOT NULL, CHANGE email email VARCHAR(50) NOT NULL, CHANGE username username VARCHAR(20) NOT NULL, CHANGE photo photo LONGBLOB DEFAULT NULL, CHANGE about about VARCHAR(400) DEFAULT \'NULL\', CHANGE role role INT DEFAULT 0 NOT NULL');
